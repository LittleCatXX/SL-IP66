...
<head>
    ...
    <a href="register.html">This is a link</a>
</head>
<body>
  <div class="container">
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #fe965a;">
      <div class="container">
        <a class="navbar-brand text-light" href="register.html">ระบบลงทะเบียนเรียน</a>
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item <?=$active_admin?>">
            <a class="nav-link text-light" href=".php">วิชาที่เปิดสอน</a>
            </li>
          <li class="nav-item <?=$active_admin?>">
          <a class="nav-link text-light" href="login-page.html">Log in</a>
          </li>
      </ul>
      </div>
    </nav>
